...
My research interest mainly includes Deep Learning and Computer Vision. Recently, I focus on exploring Generative AI ([MagicTailor](https://arxiv.org/pdf/2410.13370)@arXiv, [Dual-Schedule Inversion](https://arxiv.org/pdf/2412.11152)@WACV Oral), Multi-Modal Learning ([PointACL](https://arxiv.org/pdf/2411.14744)@arXiv, [MM-Mixing](https://arxiv.org/pdf/2405.18523)@AAAI, [SignVTCL](https://arxiv.org/pdf/2401.11847)@BMVC), and Learning with Challenging Data ([RepMode](https://openaccess.thecvf.com/content/CVPR2023/papers/Zhou_RepMode_Learning_to_Re-Parameterize_Diverse_Experts_for_Subcellular_Structure_Prediction_CVPR_2023_paper.pdf)@CVPR Highlight, [EM Loss+APL](https://arxiv.org/pdf/2203.16219)@ECCV, [IFAST](https://ieeexplore.ieee.org/abstract/document/10685520/)@IEEE TIFS, [DISCO](https://arxiv.org/pdf/2308.12017)@BMVC), aiming to promote the efficiency and flexibility of AI models and algorithms in the real world.
